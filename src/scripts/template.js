export default function template($templateCache) {
    $templateCache.put('template/color-picker/directive.html',
        ...
        '}">' +
        '   <div class="color-picker-input-wrapper" ng-cloak ng-class="{\'input-group\': AngularColorPickerController.options.swatchBootstrap && AngularColorPickerController.options.swatch}">' +
        ...
        '   </div>' +
        '   <div class="color-picker-panel ng-hide" ng-show="AngularColorPickerController.visible" ng-class="{' +
